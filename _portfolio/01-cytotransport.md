---
title: "CytoTransport"
excerpt: "In-silico modeling of cellular transport mechanisms — bridging biomedicine, computational modeling, and structural biology."
...
9 working groups from [**H-BRS**](https://www.h-brs.de/en) research institutes [**IFGA**](https://www.h-brs.de/en/ifga) (Institute for Functional Gene Analytics) and [**TREE**](https://www.h-brs.de/en/tree) (Institute for Technology, Resource and Energy-efficient Engineering), funded by the [**Deutsche Forschungsgemeinschaft (DFG)**](https://gepris.dfg.de/gepris/projekt/528562393).
...
[CytoTransport project page at H-BRS](https://www.h-brs.de/en/cytotransport){: .btn}
